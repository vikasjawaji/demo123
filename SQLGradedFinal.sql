-- Create a new database called 'gradedassignment'
CREATE DATABASE gradedassignment;
use gradedassignment;
--  Create a new table passenger
...
-- Creating another table price
create table price(Bus_type varchar(20), distance int ,  price int, primary key(bus_type,distance));
--  inserting the given records fot this table
insert into price (Bus_type, distance, price) values 
("Sleeper",350 ,770),("Sleeper",500,1100),("Sleeper",600,1320),
("Sleeper",700,1540),("Sleeper",1000,2200),("Sleeper",1200,2640),("Sleeper",1500,3000),
("Sitting", 350,434),("Sitting",500,620),("Sitting",600,744),
("Sitting",700,868),("Sitting",1000,1240),("Sitting",1200,1488),("Sitting",1500,1860);
...
select  "S " as Starts_With, passenger_name as Passenger_Name from passenger where Passenger_name like "S%";
...
-- It gives no value as there are no passengers travelling the distance of 1000KM in sitting bustype, below query is an another instance for the question, with 700km
